...
public class ManageSelectedCourseFrm extends JInternalFrame {
	...
	public ManageSelectedCourseFrm() {
		...
		selectedCourseListTable.setBackground(new Color(255, 255, 224));
		selectedCourseListTable.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, new Color(255, 255, 224)));
