...
public class ClassManagerFrm extends JInternalFrame {
	...
	public ClassManagerFrm() {
		...
		setIconifiable(true);
		setTitle("\u73ED\u7EA7\u4FE1\u606F\u7BA1\u7406");
		setBounds(113, 69, 773, 562);
		
		JScrollPane scrollPane = new JScrollPane();
		
		JLabel label = new JLabel("\u73ED\u7EA7\u540D\u79F0\uFF1A");
		label.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u73ED\u7EA7\u540D\u79F0.png")));
		...
		searchButton.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u641C\u7D22.png")));
		searchButton.setFont(new Font("微软雅黑", Font.PLAIN, 14));
		
		JLabel label_1 = new JLabel("\u73ED\u7EA7\u540D\u79F0\uFF1A");
		label_1.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u73ED\u7EA7\u540D\u79F0.png")));
		...
		label_2.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u73ED\u7EA7\u4ECB\u7ECD.png")));
		...
		submitEditButton.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u786E\u8BA4.png")));
		...
		submitDeleteButton.setIcon(new ImageIcon(ClassManagerFrm.class.getResource("/images/\u5220\u9664.png")));
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGap(18)
									.addComponent(editClassNameTextField, GroupLayout.PREFERRED_SIZE, 184, GroupLayout.PREFERRED_SIZE)))
							.addGap(64)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								.addComponent(submitDeleteButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(submitEditButton, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE))))
