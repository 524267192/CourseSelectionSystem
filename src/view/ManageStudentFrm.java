...
public class ManageStudentFrm extends JInternalFrame {
	...
	public ManageStudentFrm() {
		...
		studentListTable.setBackground(new Color(255, 255, 224));
		studentListTable.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, SystemColor.info, null, null));
	...
	private void setStudentClassInfo(){
		...
		for (StudentClass sc : studentClassList) {
			searchStudentComboBox.addItem(sc);//Ìí¼Óto's
